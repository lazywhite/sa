...
wsrep_cluster_name="hrcf"

# Group communication system handle
{% if 'roles' in grains and 'dbmaster' in grains['roles'] %}
wsrep_cluster_address="gcomm://"
{% else %}
wsrep_cluster_address="gcomm://db1:4567"
{% endif %}
...
wsrep_sst_auth=sst_user:01fa73c823cda3543efece805038b858
