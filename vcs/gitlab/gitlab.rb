...
gitlab_rails['gitlab_ssh_host'] = 'gitlab.demo.com'
...
gitlab_rails['incoming_email_address'] = "noreply@demo.com"
#
# # Email account username
# # With third party providers, this is usually the full email address.
# # With self-hosted email servers, this is usually the user part of the email address.
gitlab_rails['incoming_email_email'] = "noreply@demo.com"
...
gitlab_rails['ldap_servers'] = YAML.load <<-'EOS' # remember to close this block with 'EOS' below
  main: # 'main' is the GitLab 'provider ID' of this LDAP server
    ...
    bind_dn: 'cn=manager,dc=local,dc=com'
    password: ''
...
user['git_user_email'] = "noreply@demo.com"
...
nginx['custom_nginx_config'] = "include /usr/local/nginx/conf/vhost/*.conf;"
